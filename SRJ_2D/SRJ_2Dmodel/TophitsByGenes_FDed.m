function TbyGene=TophitsByGenes_FDed(hitstable,hitstable_lookup,pos_pad,bins,refgene,refgene_tble,UTumor,CosmicCencus,uFusionTable,bins_annot)

bin_size_th=2e6; % use in final filtering instead
max_num_gene=2; % max number of genes to list per tile

    
TbyGene = struct('bins',[],'gene_i',[],'pos_i',[],'chr_i',[],'pos_i_s',[],'pos_i_e',[],'gene_j',[],'pos_j',[],'chr_j',[],'pos_j_s',[],'pos_j_e',[],'p_val',[], 'q_val',[],'num_events',[],'annot',[],'avg_dist',[],'std_i',[],'std_j',[],'tumor_1',[],'tumor_2',[],'tumor_3',[],'tumor_1n',[],'tumor_2n',[],'tumor_3n',[],'pp',[],'pm',[],'mp',[],'mm',[]);
